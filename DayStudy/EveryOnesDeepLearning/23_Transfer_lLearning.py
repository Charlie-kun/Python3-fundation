...
train_generator=train_datagen.flow_from_directory('./data/run_project/train',
                                                  target_size=(150, 150),
                                                  batch_size=5,
                                                  class_mode='binary')
...
test_generator=test_datagen.flow_from_directory('./data/run_project/test', target_size=(150, 150), batch_size=5, class_mode='binary')
...
history=finetune_model.fit_generator(train_generator, steps_per_epoch=32, epochs=20, validation_data=test_generator, validation_steps=4)
